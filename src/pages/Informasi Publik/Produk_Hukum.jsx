                ...
                <div className='w-full flex flex-col  gap-1 lg:gap-2 font-[Poppins]'>
                  <div className='flex md:max-lg:gap-2 lg:items-center justify-between'>
                    ...
                    <Link
                      ...
                      className='flex items-center gap-2 cursor-pointer text-[8px] lg:text-[10px] py-1 px-2 text-teal-700 border border-teal-700 hover:text-white hover:bg-teal-700 hover:duration-300 rounded h-fit'
                    >
